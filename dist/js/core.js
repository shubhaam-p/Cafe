...
!(function (e) {
  ...
  function (e, t, n) {
    ...
    !(function (t, n) {
      ...
      var S = (function (e) {
        ...
        try {
          j.apply((O = P.call(x.childNodes)), x.childNodes),
          ...
          function (e, t) {
            C.fn[e] = function (n, i) {
              ...
              return (
                ...
                this.length > 1 &&
                  (I[e] || C.uniqueSort(o), P.test(e) && o.reverse()),
                this.pushStack(o)
              );
            };
          }
      ...
      function Te(e, t, n, i, o) {
        ...
        for (u.textContent = "", f = 0; (r = p[f++]); )
          if (i && C.inArray(r, i) > -1) o && o.push(r);
            ...
            ((c = se(r)), (s = be(u.appendChild(r), "script")), c && we(s), n)
          )
        ...
        special: {
          ...
          click: {
            ...
            trigger: function (e) {
              var t = this || e;
              return (
                me.test(t.type) && t.click && A(t, "input") && Oe(t, "click"),
                !0
              );
            },
            _default: function (e) {
      ...
      function Me(e, t) {
        ...
        if (1 === t.nodeType) {
          ...
          J.hasData(e) &&
            ((r = J.access(e)), (s = C.extend({}, r)), J.set(t, s));
        }
      }
      function He(e, t) {
        var n = t.nodeName.toLowerCase();
      ...
      function Re(e, t, n, i) {
        ...
        if (
          ...
          for (a = (s = C.map(be(o, "script"), Ie)).length; u < p; u++)
            (c = o),
              u !== f &&
                ((c = C.clone(c, !0, !0)), a && C.merge(s, be(c, "script"))),
              n.call(e[u], c, u);
          if (a)
            for (
              d = s[s.length - 1].ownerDocument, C.map(s, Le), u = 0;
              u < a;
              u++
            )
              (c = s[u]),
                ve.test(c.type || "") &&
                  ...
                  (c.src && "module" !== (c.type || "").toLowerCase()
                    ...
                    : x(c.textContent.replace(je, ""), c, d));
        }
        return e;
      }
      function qe(e, t, n) {
      ...
      C.extend(C.event, {
        trigger: function (e, t, i, o) {
          ...
          if (
            ...
            if (!o && !u.noBubble && !y(i)) {
              for (
                l = u.delegateType || m, Tt.test(l + m) || (s = s.parentNode);
                s;
                s = s.parentNode
              )
                h.push(s), (a = s);
        ...
        C.extend({
          ...
          ajax: function (e, t) {
            ...
            if (
              ...
              if (((k.readyState = 1), d && m.trigger("ajaxSend", [k, f]), c))
                return k;
              f.async &&
                f.timeout > 0 &&
            ...
            function S(e, t, s, l) {
              ...
              c ||
                ...
                (y = void 0),
                d &&
                  m.trigger(u ? "ajaxSuccess" : "ajaxError", [k, f, u ? p : b]),
                v.fireWith(h, [k, T]),
                d &&
      ...
      C.ajaxSetup({
        ...
        C.each(["top", "left"], function (e, t) {
          C.cssHooks[t] = Ue(g.pixelPosition, function (e, n) {
            if (n)
              return (n = Ve(e, t)), Fe.test(n) ? C(e).position()[t] + "px" : n;
          });
        }),
      ...
      return (
        (C.noConflict = function (e) {
          return (
            n.$ === C && (n.$ = Jt), e && n.jQuery === C && (n.jQuery = Kt), C
          );
        }),
        ...
        init: function () {
          this.$el.length &&
            this.$el.appear(function () {
              ...
              setTimeout(function () {
                t.addClass(
                  "animate__animated animate__".concat(t.data("animation"))
                ).addClass("visible");
              }, n);
            });
        },
    ...
    (function (e) {
      var n = {
        ...
        handleScroll: function (t) {
          var n = this;
          t > e(window).height() && !n.$el.hasClass("visible")
            ? n.$el.addClass("visible")
            : t <= e(window).height() &&
              n.$el.hasClass("visible") &&
              n.$el.removeClass("visible");
        },
      };
      t.a = n;
    }).call(this, n(1));
    ...
    (function (e) {
      ...
      var c = {
        ...
        setActiveAdditions: function (e, t) {
          var n = this;
          if (e.is(":checked"))
            (n.activeItemAdditionsTotal += t.price), n.activeAdditions.push(t);
          else {
        ...
        setActiveSize: function (e, t) {
          ...
          (o.active = !0),
            (n.activeItem.totalPrice =
              n.activeItem.totalPrice - i.price + o.price),
        ...
        Panel: {
          ...
          init: function () {
            ...
            e.DOM.$panelToggler.on("click", function () {
              return (
                e.DOM.$panel.hasClass("show") ? e.hidePanel() : e.showPanel(),
                !1
              );
            }),
          ...
          update: function () {
            ...
            t.DOM.$table.html(""),
              c.items.forEach(function (o) {
                ...
                s
                  .find('[data-action="remove-from-cart"]')
                  .on("click", function () {
              ...
              0 === o
                ? (t.DOM.$headerNotification.hide(),
                  t.DOM.$empty.show(),
                  t.DOM.$summary.hide(),
                  t.DOM.$table.hide())
                : (t.DOM.$headerNotification.show(),
          ...
          handleClick: function (e) {
            this.DOM.$panel.length &&
              "body-overlay" == e.target.id &&
              this.hidePanel();
          },
        },
        Modal: {
          ...
          init: function () {
            ...
            i.a.on("click", '[data-action="open-cart-modal"]', function () {
              ...
              t.DOM.$modal.on("show.bs.modal", function () {
                "EDIT" === t.mode
                  ? (t.DOM.$addToCart.hide(), t.DOM.$updateCart.show())
                  : (t.DOM.$addToCart.show(), t.DOM.$updateCart.hide()),
                  t.build();
              }),
            ...
            try {
              t.DOM.$name.text(c.activeItem.name),
                ...
                c.activeItem.sizes && c.activeItem.sizes.length > 1
                  ...
                  : t.DOM.$sizes.hide(),
                c.activeCategory.additions &&
                c.activeCategory.additions.length > 1
                  ? (t.DOM.$additionsList.html(""),
                    ...
                    (!c.activeItem.sizes || c.activeItem.sizes.length <= 1) &&
                      t.DOM.$additions.find(".collapse").addClass("show"))
        ...
        o = {
          ...
          init: function () {
            ...
            t.DOM.$scrollers.find("a").on("click", function () {
              ...
              return (
                console.log(i, o, r),
                (i.pathname !== o.pathname && "null" !== o.origin) ||
                  !r ||
                  "" === r ||
                  (t.scrollTo(r), n.blur()),
                !1
              ...
              t.DOM.$mobileNav
                .find("li.has-dropdown > a")
                .on("click", function () {
                  return (
                    e(this).next(".dropdown-container, ul").slideToggle(300), !1
                  );
                }),
              t.DOM.$mobileToggler.on("click", function () {
                return (
                  t.DOM.$mobilePanel.hasClass("show")
                    ? (t.DOM.$mobilePanel.removeClass("show"), i.b.fadeOut(400))
                    : (t.DOM.$mobilePanel.addClass("show"), i.b.fadeIn(400)),
                  !1
                );
              });
          },
          scrollTo: function (t) {
            var n = e(t);
            n.length
              ? e("html, body").animate({ scrollTop: n.offset().top }, 600)
              : console.error(
                  "[NAVIGATION] Wrong href - the ID does not exist in the DOM"
                );
          },
          handleClick: function (e) {
            ("body" != e.target.localName &&
              "html" != e.target.localName &&
              "body-wrapper" != e.target.id) ||
              (this.DOM.$nav
                .find("li.dropdown-show")
                .removeClass("dropdown-show"),
              i.a.removeClass("dropdown-visible"));
          },
          ...
          handleScroll: function (t) {
            ...
            if (n.$el.length) {
              ...
              e(window).width() <= 991 && (o = i.d.outerHeight()),
                ...
                t > i.c.offset().top - n.$el.outerHeight() &&
                  n.$el.css({
                    position: "absolute",
                    top:
                      i.c.offset().top - n.$el.outerHeight() - n.offset + "px",
                  });
            }
          },
        };
  ...
  function (e, t, n) {
    ...
    (function (e) {
      var n = {
        init: function (t) {
          e(
            ".bg-image, .post-wide .post-image, .post.single .post-image",
            t || "html"
          ).each(function () {
            var t = e(this),
    ...
    (function (e) {
      ...
      var i = {
        ...
        MainTwo: {
          ...
          init: function () {
            this.$el.length &&
              this.$el.slick({ dots: !0, speed: 800, arrows: !0 });
          },
        },
        Gallery: {
          DOM: {
  ...
  function (e, t, n) {
    ...
    var i = n(25),
      o = {
        init: function () {
          Object(i.jarallax)(
            document.querySelectorAll(".bg-image.bg-parallax"),
            { speed: 0.75 }
          );
        },
      };
          ...
          typeof (i = function () {
            ...
            function x(e) {
              if (void 0 !== e && e.innerHTML.indexOf("data-image") >= 0) {
                for (
                  var t = e.innerHTML.match(/data-image=\"([^"]+)\"/gi), n = 0;
                  n < t.length;
                  n++
                )
            ...
            var T = {
              fetch: function (l) {
                if (
                  ...
                  null !== v && y.removeChild(v),
                    ((v = document.createElement("script")).type =
                      "text/javascript"),
                    void 0 !== l.list
                      ? (v.src =
              ...
              callback: function (v) {
                if (void 0 === v || void 0 === v.body)
                  return (
                    (o = !1),
                    void (i.length > 0 && (T.fetch(i[0]), i.splice(0, 1)))
                  );
                f ||
                ...
                function k(e) {
                  ...
                  if (t) t.src = t.getAttribute("data-src-2x");
                    ...
                    i.setAttribute(
                      "src",
                      "https://twitter.com/" + n + "/profile_image?size=bigger"
                    ),
                      e.prepend(i);
                  }
                  return e;
                ...
                if (l)
                  for (
                    var j = C.getElementsByClassName("timeline-Tweet");
                    N < j.length;

                  )
                    j[N].getElementsByClassName("timeline-Tweet-retweetCredit")
                      .length > 0
                      ? A.push(!0)
                      : A.push(!1),
                      (!A[N] || (A[N] && c)) &&
                        (S.push(
                          j[N].getElementsByClassName("timeline-Tweet-text")[0]
                        ),
                        ...
                        void 0 !==
                        j[N].getElementsByClassName("timeline-Tweet-media")[0]
                          ? _.push(
                              j[N].getElementsByClassName(
                  ...
                  for (j = w(C, "timeline-Tweet"); N < j.length; )
                    w(j[N], "timeline-Tweet-retweetCredit").length > 0
                      ? A.push(!0)
                      : A.push(!1),
                      (!A[N] || (A[N] && c)) &&
                        ...
                        void 0 !== w(j[N], "timeline-Tweet-media")[0]
                          ? _.push(w(j[N], "timeline-Tweet-media")[0])
                          : _.push(void 0)),
                      N++;
                S.length > t &&
                    ...
                    P.push({
                      ...
                      author_data: {
                        ...
                        screen_name: E[I]
                          ...
                          : null,
                        name: E[I]
                          ? E[I].querySelector('[data-scribe="element:name"]')
                              .title
                          : null,
                      },
                      time: $[I].textContent,
                  ...
                  for (; I < N; ) {
                    if ("string" != typeof a) {
                      var L = $[I].getAttribute("datetime"),
                        ...
                        H = a(M, L);
                      if (
                        ($[I].setAttribute("aria-label", H), S[I].textContent)
                      )
                    ...
                    if (
                      (n
                        ? (h && (b(S[I]), s && b(E[I])),
                          s &&
                            (F +=
                              ...
                              "</div>"),
                          (F +=
                            '<p class="tweet">' + y(S[I].innerHTML) + "</p>"),
                          r &&
                            (F += m
                        ...
                        : (S[I].textContent,
                          s &&
                            (F +=
                              '<p class="user">' + E[I].textContent + "</p>"),
                          (F +=
                            '<p class="tweet">' + S[I].textContent + "</p>"),
                          r &&
                            (F +=
                              '<p class="timePosted">' +
                              $[I].textContent +
                      ...
                      for (var z = x(_[I]), B = 0; B < z.length; B++)
                        F +=
            ...
            typeof (i = function (e) {
                ...
                n = {
                  init: function (i) {
                    ...
                    return o || !(i.browser.length > 0) || (o && this.length)
                      ? (n.optionCheck.call(this, i) &&
                          e("." + i.overlayClass).length <= 0 &&
                          n.addOverlay.call(this, i),
                        i.loading &&
                          e("." + i.loadingClass).length <= 0 &&
                          n.addLoading.call(this, i),
                        this.each(function () {
                          var o = this,
                            r = e(this),
                            s = e(window),
                  ...
                  in: function () {
                    ...
                    o.loading && n.removeLoading.call(this),
                      d && i.removeClass(d),
                      c
                        ? n.inOverlay.call(this, l, a)
                        : n.inDefault.call(this, l, a);
                  },
                  ...
                  out: function (i, o) {
                    ...
                    (r.data(t).outClass = f),
                      m
                        ? n.outOverlay.call(this, f, h, o)
                        : n.outDefault.call(this, f, h, o);
                  },
              ...
              (e.fn.animateCallback = function (t) {
                ...
                (e.fn.animsition = function (i) {
                  return n[i]
                    ? n[i].apply(this, Array.prototype.slice.call(arguments, 1))
                    : "object" != typeof i && i
                    ? void e.error(
                        "Method " + i + " does not exist on jQuery." + t
                      )
      ...
      var s = "collapse",
        ...
        u = (function () {
          ...
          return (
            ...
            (p._getConfig = function (e) {
              return (
                ((e = r(r({}, c), e)).toggle = Boolean(e.toggle)),
              ...
              l.forEach(function (e) {
                (function (e, t) {
                  ...
                  if (-1 !== t.indexOf(n))
                    return (
                      -1 === a.indexOf(n) ||
                      Boolean(e.nodeValue.match(c) || e.nodeValue.match(d))
                    );
                  for (
            ...
            modifiers: {
              ...
              arrow: {
                ...
                fn: function (e, t) {
                  ...
                  return (
                    (w = Math.max(Math.min(a[d] - m, w), 0)),
                    (e.arrowElement = i),
                    (e.offsets.arrow =
                      (C((n = {}), p, Math.round(w)), C(n, f, ""), n)),
                    e
                  );
                },
                element: "[x-arrow]",
        ...
        d = (function () {
          ...
          return (
            ...
            (u._getConfig = function (n) {
              if (
                "string" !=
                  typeof (n = r(r({}, l), "object" == typeof n && n ? n : {}))
                    .target &&
                t.isElement(n.target)
              ) {
                var i = e(n.target).attr("id");
                i || ((i = t.getUID(s)), e(n.target).attr("id", i)),
                  (n.target = "#" + i);
              }
            ...
            (i._jQueryInterface = function (t) {
              return this.each(function () {
                ...
                if (
                  (n ||
                    ((n = new i(this, "object" == typeof t && t)),
            ...
            e.extend(e.fn, {
              ...
              rules: function (t, n) {
                ...
                if (
                  ...
                  if (t)
                    switch (
                      ((o = (i = e.data(c.form, "validator").settings).rules),
              ...
              e.extend(e.validator, {
                ...
                prototype: {
                  ...
                  check: function (t) {
                    ...
                    if (!l)
                      return (
                        this.objectLength(s) && this.successList.push(t), !0
                      );
                  },
        ...
        (e.prototype.load = function () {
          ...
          return void 0 !== this.api
            ...
            : ((window[e.CALLBACK_NAME] = function () {
                if (((t.api = window.google), void 0 === t.resolve))
      ...
      onScroll(e) {
        ...
        if (
          ...
          ("opacity" !== t.options.type &&
            ...
            ((s.transform = "translate3d(0,0,0)"), (s.opacity = g)),
          "scale" === t.options.type || "scale-opacity" === t.options.type)
        ) {
          let e = 1;
          0 > t.options.speed
            ? (e -= t.options.speed * g)
            : (e += t.options.speed * (1 - g)),
      ...
      for (; r < i; r += 1)
        if (
          ("object" == typeof t || void 0 === t
            ? e[r].jarallax || (e[r].jarallax = new g(e[r], t))
            : e[r].jarallax && (o = e[r].jarallax[t].apply(e[r].jarallax, n)),
          void 0 !== o)
        )
          return o;
      return e;
        ...
        t.prototype[e] = function (...t) {
          ...
          if (
            ("initImg" === e &&
              ...
              (i.pureOptions.speed =
                i.$item.getAttribute("data-jarallax-element") ||
                i.pureOptions.speed)),
          ...
          switch (
            ...
            case "onScroll":
              const l = i.getWindowData(),
                c =
                  (l.y + l.height / 2 - i.itemData.y - i.itemData.height / 2) /
                  (l.height / 2),
              ...
              null !== i.options.thresholdY &&
                d > i.options.thresholdY &&
                (p = 0),
                null !== i.options.thresholdX &&
                  u > i.options.thresholdX &&
                  (f = 0),
                i.css(i.$item, { transform: `translate3d(${f}px,${p}px,0)` });
              break;
            case "initImg":
            case "isVisible":
            case "clipContainer":
  ...
  function (e, t) {
    !(function () {
      ...
      for (
        var o = "", r = t.getElementsByTagName("script"), s = r.length;
        --s >= 0;
      ...
      o.replace(/[?&]([^&=]+)=([^&]+)/g, function (e, t, n) {
        (n = decodeURIComponent(n)),
          "autorun" == (t = decodeURIComponent(t))
            ? (c = !/^[0fn]/i.test(n))
            : "lang" == t
            ? d.push(n)
            : "skin" == t
      ...
      for (
        var f = "https://cdn.rawgit.com/google/code-prettify/master/loader",
          h = ((s = 0), d.length);
        s < h;
        ++s
      )
        ...
        return (
          ...
          (function () {
            ...
            function g(e, t) {
              ...
              !(function () {
                for (
                  var o = e.concat(t), r = [], s = {}, a = 0, l = o.length;
                  a < l;
                  ++a
                ) {
                  var c = o[a],
                ...
                r.push(/[\0-\uffff]/),
                  (n = (function (e) {
                    for (
                      var t = 0, n = !1, i = !1, o = 0, r = e.length;
                      o < r;
                      ++o
                    ) {
            ...
            function b(e, t, n) {
                  ...
                  var t,
                    n = (function e(t, n) {
                      ...
                      if (o) {
                        ...
                        r.appendChild(i);
                        for (var a = s; a; a = s)
                          (s = a.nextSibling), r.appendChild(a);
                      }
                      return i;
                    })(e.nextSibling, 0);
              ...
              for (
                var p = Math.max(0, (t - 1) | 0) || 0, f = ((d = 0), a.length);
                d < f;
                ++d
              )
                      ...
                      for (; d < c; ) {
                        ...
                        if (1 !== T.nodeType && (b = r.substring(a, g))) {
                          ...
                          S.replaceChild(k, T),
                            ...
                            a < w &&
                              ((l[d + 1] = T =
                                C.createTextNode(r.substring(g, w))),
            ...
            function S(e, n) {
              ...
              for (
                var s = [r("pre"), r("code"), r("xmp")], a = [], l = 0;
                l < s.length;
                ++l
              )
              ...
              !(function n() {
                for (
                  var i = t.PR_SHOULD_USE_CONTINUATION ? u.now() + 250 : 1 / 0;
                  p < a.length && u.now() < i;
                  p++
                ) {
                      ...
                      if (v.test(r.tagName)) _ = 1;
                        ...
                        var O = r.currentStyle,
                          ...
                          N = O
                            ...
                            ? D.getComputedStyle(r, null).getPropertyValue(
                                "white-space"
                              )
                            : 0;
            ...
            x(y, ["default-code"]),
              ...
              x(v({ keywords: u, hashComments: !0, multiLineStrings: !0 }), [
                "bash",
                "bsh",
                "csh",
                "sh",
              ...
              x(v({ keywords: a, cStyleComments: !0, regexLiterals: !0 }), [
                "javascript",
                "js",
                "ts",
                "typescript",
        ...
        c &&
          (function (i) {
            var o = t.addEventListener,
              ...
              c = o ? "" : "on",
              d = function (n) {
                ("readystatechange" == n.type && "complete" != t.readyState) ||
                  (("load" == n.type ? e : t)[l](c + n.type, d, !1),
          ...
          init: function () {
            ...
            t.colors.forEach(function (t) {
              ...
              t.$styleswitcher.find("ul a").on("click", function () {
                return (
                  e(this).parents("ul").find("a.active").removeClass("active"),
            ...
            //     e("#style-switcher-wrapper").toggleClass("show"),
            //       t.stopPropagation();
            //   }),
              e("#style-switcher .style-switcher-close").on(
                "click",
                function (t) {
    ...
    class f {
      ...
      play(e) {
        ...
        t.player &&
          ("youtube" === t.type &&
            ...
            o.a.YT.PlayerState.PLAYING !== t.player.getPlayerState() &&
              t.player.playVideo()),
          "vimeo" === t.type &&
      ...
      pause() {
        ...
        e.player &&
          ("youtube" === e.type &&
            e.player.pauseVideo &&
            o.a.YT.PlayerState.PLAYING === e.player.getPlayerState() &&
            e.player.pauseVideo(),
          "vimeo" === e.type &&
          ...
          if ("youtube" === t.type) {
            ...
            (o.onload = function () {
              120 !== (this.naturalWidth || this.width) || i === n.length - 1
                ? ((t.videoImage = `https://img.youtube.com/vi/${t.videoID}/${n[i]}.jpg`),
                  e(t.videoImage))
                : ((i += 1),
        ...
        t.$video
          ...
          : t.onAPIready(() => {
              ...
              if (
                  ...
                  (t.playerOptions.events = {
                    onReady(e) {
                      ...
                      setInterval(() => {
                        t.getVolume((n) => {
                          t.options.volume !== n &&
                            ((t.options.volume = n), t.fire("volumechange", e));
                        });
                      }, 150);
                    },
                    onStateChange(n) {
                      t.options.loop &&
                        n.data === o.a.YT.PlayerState.ENDED &&
                        t.play(t.options.startTime),
                        e ||
                          n.data !== o.a.YT.PlayerState.PLAYING ||
                          ((e = 1), t.fire("started", n)),
                        n.data === o.a.YT.PlayerState.PLAYING &&
                          t.fire("play", n),
                        n.data === o.a.YT.PlayerState.PAUSED &&
                          t.fire("pause", n),
                        n.data === o.a.YT.PlayerState.ENDED &&
                          t.fire("ended", n),
                        n.data === o.a.YT.PlayerState.PLAYING
                ...
                (t.player =
                  t.player || new o.a.YT.Player(t.playerID, t.playerOptions)),
                  r &&
              ...
              if ("vimeo" === t.type) {
                ...
                let e;
                (t.player =
                  t.player || new o.a.Vimeo.Player(t.$video, t.playerOptions)),
                  t.options.startTime &&
                    t.options.autoplay &&
